...
public class EmployeeRepositoryUnitTest {
	...
	public EmployeeRepositoryUnitTest() {
		emps=new Employee[] {
				new Employee("meghana","damera",45000,LocalDate.now(),Department.DEVELOPMENT,"9951537897","a.push@gmail.com")
		};
	}
	...
	public void whenFindByMobileNumber_withNonExistingMobileNumber_thenReturnNull() {
		Employee e=employeeRepository.findByMobileNumber("1234564765");
		assertThat(e).isNull();
	}
